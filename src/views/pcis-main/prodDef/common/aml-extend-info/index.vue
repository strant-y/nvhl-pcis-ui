...
const appExtendInfo = defineAsyncComponent(
  () => import("./app-extend-info/app-extend-info.vue")
);
const insExtendInfo = defineAsyncComponent(
  () => import("./ins-extend-info/ins-extend-info.vue")
);
import {
  getButtonByFacKey,
  getFactorList,
