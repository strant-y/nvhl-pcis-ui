...
<script setup lang="ts">
    ...
    let addrowArr=['cAppNo','cPlyNo','cEdrNo','cDptCnm','cSecondDptCnm','cProdNmeCn','cTermNme','cUdrNme','tUdrTm']
    // 变更列
    ...
    const tableCol = ref<Array<any>>([
        ...
        { title: "二级分公司", prop: "cSecondDptCnm", inputtype: "rtinput", minWidth: 180 },
