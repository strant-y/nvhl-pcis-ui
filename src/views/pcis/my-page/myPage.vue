    ...
    if(props.param?.pageName === "priceInquiry") {
      ...
      rightBtnList.value = basicRightBtn;
		...
		if(props.param.cRecordType === 9){
          ...
          dataInit.value.base["Base.cInstMrk"] = res.data.policyApplication?.composition?.plyBase[0]["Base.cInstMrk"] || "";
          dataInit.value.base["Base.nPayNum"] = res.data.policyApplication?.composition?.plyBase[0]["Base.nPayNum"] || "";
