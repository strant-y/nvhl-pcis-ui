...
const reinsuranceEdit = defineAsyncComponent(
  () => import("./reinsuranceEdit.vue")
);
import {
  AppTableConfig,
  AppTableMethod,
  ...
  createTableEditConfig({
    titleBtns: [
      createFreeButtonBase({
        ...
        func: function () {
          dzmodal
            .open(reinsuranceAdd, { type: "add", data: {} })
            .then((res) => {
              if (res.type === "ok") {
                handleQuery();
              }
    ...
    tableBtn: [
      createFreeButtonBase({
        ...
        tableClick: (row) => {
          console.log(row);
          dzmodal
            .open(reinsuranceEdit, { type: "edit", data: row })
            .then((res) => {
              if (res.type === "ok") {
                handleQuery();
              }
      ...
      createFreeButtonBase({
        ...
        tableClick: (row) => {
          dzmodal
            .open(reinsuranceEdit, { type: "view", data: row })
            .then((res) => {
              if (res.type === "ok") {
                handleQuery();
              }
