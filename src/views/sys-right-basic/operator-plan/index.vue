...
const searchPlanEcargo = defineAsyncComponent(
  () => import("./search-plan-ecargo.vue")
);
  ...
  createTableEditConfig({
    ...
    tableBtn: [
      createFreeButtonBase({
        ...
        tableClick: (row) => {
          dzmodal
            .open(searchPlanEcargo, { type: "update", data: row })
            .then((res) => {
              if (res.type === "ok") {
                handleQuery();
              }
...
function handleQuery(flag?: boolean) {
  ...
  sysOperatorPlanService
    .qryEcargoOperatorList(param)
    .then((res) => {
