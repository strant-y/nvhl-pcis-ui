...
let cOpTypeOption = [];
const sysOpInfoEdit = defineAsyncComponent(
  () => import("./sys-op-info-edit.vue")
);
  ...
  createTableEditConfig({
    ...
    fromSchema: [
      ...
      },
      {
        ...
        formatter: (val) => {
          const item =
            codeListMap["CParentCde"].length &&
            codeListMap["CParentCde"].find((item) => item.value === val);
      ...
      },
      {
        ...
        formatter: (val) => {
          const item =
            codeListMap["COpType"].length &&
            codeListMap["COpType"].find((item) => item.value === val);
          return item ? item.label : val;
        },
      },
    ],
