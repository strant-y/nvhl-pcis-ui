<template>
  <el-dialog v-model="dialogVisible" width="90%">
    <app-table :tableConfig="tableconfig" v-model:pageresult="pageresult" ref="tableRef"
      ...
      <div style="margin-top: 1rem; margin-bottom: 1rem; margin-right: 2rem;" align="right">
      <el-button
        type="primary"
...
const saveData = () => {
  ...
  sysOperatorMgrService.saveUsrRoleList({
    CCrtCde: user.opCde,
...
const loadData = () => {
  ...
  sysOperatorMgrService.getUserAssociateRoles({
    userId: props.COperId,
    CDptCde: props.CDptCde,
