...
const toggleSpecificRow = () => {
  ...
  if((!!param.cAppNo && param.cAppNo.length > 18) || (!!param.cEcAgrAppNo && param.cEcAgrAppNo.length > 18)){
    if (!!param.pageType && (param.pageType === "EDR_APP_NEW_SCENE" || (param.pageType === "TEMPORARY_DEPOSIT" && param.cTransMrk !=='1')) && param.cRsnCde == "FZ") {
      return false
    }
	}
